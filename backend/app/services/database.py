...
class DatabaseService:
    ...
    async def get_dashboard_stats(self) -> dict:
        ...
        # Performance optimization: Execute independent Supabase HTTP requests concurrently
        # using thread pooling to bypass the GIL and eliminate sequential I/O blocking.
