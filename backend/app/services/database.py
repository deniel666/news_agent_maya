...
class DatabaseService:
    ...
    async def get_dashboard_stats(self) -> dict:
        ...
        # ⚡ Bolt Optimization: Use asyncio.gather to concurrently fetch dashboard statistics,
        # eliminating sequential query blocking and significantly reducing overall latency.
    ...
    async def get_content_stats(self) -> ContentStats:
        ...
        # ⚡ Bolt Optimization: Use asyncio.gather to concurrently fetch content statistics across
        # multiple tables, reducing sequential I/O bottlenecks.
