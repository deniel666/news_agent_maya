...
class DatabaseService:
    ...
    async def get_dashboard_stats(self) -> dict:
        ...
        # using asyncio.gather and to_thread to prevent blocking network calls
        # from executing sequentially, reducing total latency to the slowest query.
    ...
    async def get_content_stats(self) -> ContentStats:
        ...
        # Bolt Optimization: Batch five independent database calls
        # together using asyncio.gather to eliminate sequential
        # N+1 blocking network calls.
