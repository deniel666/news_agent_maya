...
class DatabaseService:
    ...
    async def get_dashboard_stats(self) -> dict:
        ...
        # Run independent aggregate queries concurrently to avoid sequential blocking
    ...
    async def list_stories(
        ...
        # Batch fetch videos and publish records concurrently
    ...
    async def get_content_stats(self) -> ContentStats:
        ...
        # Batch independent aggregate queries concurrently
