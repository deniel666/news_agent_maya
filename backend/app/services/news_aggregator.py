...
class NewsAggregatorService:
    ...
    def _parse_rss_content(self, content: str, source_name: str, cutoff: datetime) -> List[NewsArticle]:
        """Synchronously parse RSS content."""
        articles = []
        try:
    ...
    def _parse_nitter_content(self, content: str, source_name: str, cutoff: datetime) -> List[NewsArticle]:
        """Synchronously parse Nitter content."""
        articles = []
        try:
            feed = feedparser.parse(content)
            ...
            print(f"Error parsing Nitter {source_name}: {e}")
